...
class info:
    ...
    pkt_space = {   0: [1,1,1,1,1,4,2],
                    ...
                    131: [1,1,1,1,1,1,4,4,2],
                    132: [1,1,1,1,1,1,4,4,4,4,4,4,4,2],
                    133: [1,1,1,1,1,1,4,2]
                }
   # Initialize packet
    pkt_item = {
        ...
        131: ["header", "msgID", "OTHER.sysID", "OTHER.compID", "OTHER.commID",
             "Waypt_count", "Desired_dist", "OTHER.systime", "checksum"],
    ...
    mission_mode_mapping = {179:mavutil.mavlink.MAV_CMD_DO_SET_HOME,22: mavutil.mavlink.MAV_CMD_NAV_TAKEOFF,
     16:mavutil.mavlink.MAV_CMD_NAV_WAYPOINT,19: mavutil.mavlink.MAV_CMD_NAV_LOITER_TIME,21: mavutil.mavlink.MAV_CMD_NAV_LAND,20: mavutil.mavlink.MAV_CMD_NAV_RETURN_TO_LAUNCH}
